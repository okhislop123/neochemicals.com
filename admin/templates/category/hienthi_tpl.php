		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				for ($i = 0; $i < $count; $i++) { ?>
					<tr>
						<td>
							<?php if ($items[$i]['id'] != 1288 && $items[$i]['id'] != 1288 && $items[$i]['id'] != 1296 && $items[$i]['id'] != 1297 && $items[$i]['id'] != 1291 && $items[$i]['id'] != 1310 && $items[$i]['id'] != 1313 && $items[$i]['id'] != 1315 && $items[$i]['id'] != 1316 && $items[$i]['id'] != 1317 && $items[$i]['id'] != 1318 && $items[$i]['id'] != 1319 && $items[$i]['id'] != 1130 && $items[$i]['id'] != 1314) { ?>
