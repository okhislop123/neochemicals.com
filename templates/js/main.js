...
$(document).ready(function () {
  ...
  $(".chungnhan__group.owl-carousel").owlCarousel({
    margin: 20,
    nav: true,
    dots: false,
    loop: true,
  ...
  $(".khachhang__group.owl-carousel").owlCarousel({
    margin: 30,
    nav: false,
    dots: true,
    loop: true,
  ...
  $(".pogroup__group.owl-carousel").owlCarousel({
    margin: 20,
    nav: false,
    dots: false,
    loop: true,
...
myHeader = document.querySelector("nav.navbar.navbar-default.xs-none");
